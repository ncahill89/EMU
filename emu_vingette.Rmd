---
title: "Estimating mCPR for married women with custom EMU data"
author: "Niamh Cahill"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Estimating mCPR for married women with custom EMU data}
...
## 1. Format of EMU dataset

The dataset containing EMUs that have been derived from service
statistics must contain the following columns

1.  **division_numeric_code:** UNPD country code
2.  **name:** Country name
3.  **year:** the mid point of the observation year
4.  **emu:** estimated modern use that has been derived from the
    [http://www.track20.org/pages/track20_tools/SS_to_EMU_tool.php](SS%20to%20EMU%20tool)
